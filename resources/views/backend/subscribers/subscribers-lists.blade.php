...
@section('page-title','Subscribers | Lists')
@push('page-css')
<!-- DataTables -->
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="page-title-box">
            <h4 class="page-title float-left">Subscribers Lists</h4>
            <ol class="breadcrumb float-right">
              <li class="breadcrumb-item"><a href="#">Achia</a></li>
              <li class="breadcrumb-item"><a href="#">Subscribers Lists</a></li>
            </ol>
    ...
    <div class="row">
      <div class="col-12">
          <div class="card-box table-responsive">
              <h4 class="m-t-0 header-title pb-3">Total Subscribers <Strong>({{ $subscribers->count() }})</Strong></h4>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <button type="button" class="btn btn-danger btn-sm" onclick="deleteifno({{ $subscriber->id }})">
