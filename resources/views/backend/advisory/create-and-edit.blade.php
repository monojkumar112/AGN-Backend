                ...
                <div class="col-xl-12">
                    <div class="page-title-box">
                        <div class="d-flex justify-content-between align-items-center text-muted">
                            <h4 class="page-title float-left new-clg"><i class="zmdi zmdi-sliderger"></i> Advisory
                                {{ isset($advisory) ? 'Edit' : 'Create' }}</h4>
                            <ol class="breadcrumb float-right">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('admin.advisory.index') }}" class="btn btn-danger">
            ...
            <div class="row">
                <div class="col-12">
                    <form id="roleFrom" role="form" method="POST"
                        action="{{ isset($advisory) ? route('admin.advisory.update', $advisory->id) : route('admin.advisory.store') }}"
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $advisory->name ?? old('name') }}" id="name"
                                                    name="name" required>
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $advisory->designation ?? old('designation') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="logo" class="dropify" name="logo" type="file">
                                            </div>
                                            @if (!empty($advisory->logo))
                                                <div class="mb-3">
                                                    <label class="form-label">Current Image</label>
                                                    <br>
                                                    <img src="{{ asset($advisory->logo) }}" alt="Current Image"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="image" class="form-label">Upload advisory Image </label>
                                            ...
                                            @if (!empty($advisory->image))
                                                <div class="mb-3">
                                                    <label class="form-label">Current Image</label>
                                                    <br>
                                                    <img src="{{ asset($advisory->image) }}" alt="Current Image"
                                                        style="max-width: 200px; height: auto;">
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <fieldset class="form-group">
                                        <div class="switchery-demo m-t-20">
                                            <input type="checkbox"
                                                @isset($advisory) {{ $advisory->status == true ? 'checked' : '' }} @endisset
...
@push('page-js')
    ...
    <script>
        $('#addInput').click(function() {
            ...
            <div class="mb-2">
                <input type="text" name="advisorys[]" class="form-control" placeholder="Enter advisory">
            </div>
        `);
        });
    </script>
