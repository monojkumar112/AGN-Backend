                ...
                <div class="col-xl-12">
                    <div class="page-title-box">
                        <div class="d-flex justify-content-between align-items-center text-muted">
                            <h4 class="page-title float-left new-clg"><i class="zmdi zmdi-sliderger"></i> event Team
                                {{ isset($event) ? 'Edit' : 'Create' }}</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <form id="roleFrom" role="form" method="POST"
                        action="{{ isset($event) ? route('admin.event.update', $event->id) : route('admin.event.store') }}"
                                ...
                                <div class="card-box">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $event->name ?? old('name') }}" id="name" name="name"
                                                    required>
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if (!empty($event->logo))
                                                <div class="mb-3">
                                                    ...
                                                    <br>
                                                    <img src="{{ asset($event->logo) }}" alt="Current Image"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if (!empty($event->image))
                                                <div class="mb-3">
                                                    <label class="form-label">Current Image</label>
                                                    <br>
                                                    <img src="{{ asset($event->image) }}" alt="Current Image"
                                                        style="max-width: 200px; height: auto;">
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <fieldset class="form-group">
                                        <div class="switchery-demo m-t-20">
                                            <input type="checkbox"
                                                @isset($event) {{ $event->status == true ? 'checked' : '' }} @endisset
