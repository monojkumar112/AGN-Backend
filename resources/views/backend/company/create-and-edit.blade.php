                ...
                <div class="col-xl-12">
                    <div class="page-title-box">
                        <div class="d-flex justify-content-between align-items-center text-muted">
                            <h4 class="page-title float-left new-clg"><i class="zmdi zmdi-sliderger"></i> Company Logo
                                {{ isset($company) ? 'Edit' : 'Create' }}</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <form id="roleFrom" role="form" method="POST"
                        action="{{ isset($company) ? route('admin.company.update', $company->id) : route('admin.company.store') }}"
                                ...
                                <div class="card-box">
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $company->name ?? old('name') }}" id="name"
                                                    name="name" required>
                                                @error('name')
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @if (!empty($company->image))
                                                <div class="mb-3">
                                                    ...
                                                    <br>
                                                    <img src="{{ asset($company->image) }}" alt="Current Image"
                                    ...
                                    <fieldset class="form-group">
                                        <div class="switchery-demo m-t-20">
                                            <input type="checkbox"
                                                @isset($company) {{ $company->status == true ? 'checked' : '' }} @endisset
