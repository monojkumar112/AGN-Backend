                ...
                <div class="col-xl-12">
                    <div class="page-title-box">
                        <div class="d-flex justify-content-between align-items-center text-muted">
                            <h4 class="page-title float-left new-clg"><i class="zmdi zmdi-sliderger"></i> Technology Team
                                {{ isset($technology) ? 'Edit' : 'Create' }}</h4>
                            <ol class="breadcrumb float-right">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('admin.technology.index') }}" class="btn btn-danger">
            ...
            <div class="row">
                <div class="col-12">
                    <form id="roleFrom" role="form" method="POST"
                        action="{{ isset($technology) ? route('admin.technology.update', $technology->id) : route('admin.technology.store') }}"
                            ...
                            <div class="col-md-10">
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $technology->name ?? old('name') }}" id="name"
                                                    name="name" required>
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $technology->designation ?? old('designation') }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if (!empty($technology->logo))
                                                <div class="mb-3">
                                                    ...
                                                    <br>
                                                    <img src="{{ asset($technology->logo) }}" alt="Current Image"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="image" class="form-label">Upload technology Image </label>
                                            ...
                                            @if (!empty($technology->image))
                                                <div class="mb-3">
                                                    <label class="form-label">Current Image</label>
                                                    <br>
                                                    <img src="{{ asset($technology->image) }}" alt="Current Image"
                                                        style="max-width: 200px; height: auto;">
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <fieldset class="form-group">
                                        <div class="switchery-demo m-t-20">
                                            <input type="checkbox"
                                                @isset($technology) {{ $technology->status == true ? 'checked' : '' }} @endisset
