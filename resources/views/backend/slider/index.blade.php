...
@section('page-title', 'slider-List || Admin')
@push('page-css')
    <!-- DataTables -->
                    ...
                    <div class="page-title-box">
                        <div class="d-flex justify-content-between align-items-center text-muted">
                            <h4 class="page-title float-left">
                                <i class="zmdi zmdi-sliderger"></i> Slider
                            </h4>
                            ...
                            <tbody>
                                @foreach ($sliders as $key => $slider)
                                    <tr>
                                        ...
                                        <td>{{ Str::words($slider->name, 10, '[..]') }}</td>
                                        <td>{{ Str::words($slider->description, 10, '[..]') }}</td>
                                        <td>
                                            <img src="{{ $slider->image != null ? asset($slider->image) : asset('assets/application-default/img/gallery.jpg') }}"
                                                alt="" style="width: 80px;">

                                        </td>
                                        <td>
                                            <span
                                                class="badge {{ $slider->status == true ? 'badge-info' : 'badge-danger' }}">{{ $slider->status == true ? 'Active' : 'Inactive' }}</span>
                                        </td>
